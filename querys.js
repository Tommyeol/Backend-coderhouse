...
//1) Agregar 10 documentos con valores distintos a las colecciones mensajes y productos. El formato de los documentos debe estar en correspondencia con el que venimos utilizando en el entregable con base de datos MariaDB. 
    ...
    -MENSAJES:
    db.mensajes.insert([{ email: "john@gmail.com", text: "Hola, que tal?",timestamp:ISODate()}, { email: "dior@yahoo.com", text: "Bieeeen!", timestamp:ISODate()},{ email: "trevor@gmail.com", text: "hola, chicos!", timestamp:ISODate()},{ email: "dinah@gmail.com", text: "Que onda?", timestamp:ISODate()}, { email: "john@gmail.com", text: "Estoy para salir...", timestamp:ISODate()}, { email: "dior@yahoo.com", text: "Vas a salir sin nosotros?", timestamp:ISODate()}, { email: "trevor@gmail.com", text: "Quiero ir también!", timestamp:ISODate()}, { email: "dinah@gmail.com", text: "Donde vas?", timestamp:ISODate()}, { email: "john@gmail.com", text: "Pero voy al mercado...", timestamp:ISODate()}, { email: "dior@yahoo.com", text: "Uff...", timestamp:ISODate()}])
...
//6) Crear un usuario 'tommy' clave: 'dht548' que sólo pueda leer la base de datos ecommerce. Verificar que tommy no pueda cambiar la información.

    use admin
    db.createUser({"user":"tommy", pwd: "dht548", roles:[{role:"read", db:"ecommerce"}]})